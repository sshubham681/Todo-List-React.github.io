    ...
    <div className="add-task-dialog">
      ...
      <div className="add-task-actions-container">
        ...
        <div className="icon-container">
          <DayPickerInput onDateChange={(day) => setDate(day)} placeholder={`${dateFnsFormat(new Date(), FORMAT)}`}
...
const Tasks = ({ selectedTab }) => {
  ...
  return (
    <div className="tasks">
      ...
      {tasks.length > 0 ?
        <TaskItems tasks={tasks} selectedTab={selectedTab} /> : <p>No task pending</p>}
